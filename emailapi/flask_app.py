...
app.config['MAIL_USERNAME'] = 'thecoldprogrammer@gmail.com'
app.config['MAIL_PASSWORD'] = 'SenM@rcoRub1o'
...
def send_email():
    ...
    msg = Message('Driving Log', sender='thecoldprogrammer@gmail.com', recipients=[recipient])
